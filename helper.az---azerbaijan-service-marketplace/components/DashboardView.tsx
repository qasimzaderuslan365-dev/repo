...
export const DashboardView: React.FC<Props> = ({ user, language, offers, onToggleAvailability }) => {
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-8">
            ...
            <div className="mt-8 space-y-2">
              <button className="w-full py-3 px-4 text-left text-sm font-semibold rounded-xl hover:bg-gray-50 text-gray-700">Profilimi redaktə et</button>
              ...
              <button className="w-full py-3 px-4 text-left text-sm font-semibold rounded-xl hover:bg-gray-50 text-red-600">Çıxış</button>
            </div>
          </div>
        </div>
